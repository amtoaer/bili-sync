...
use crate::api::request::{CreateSourceCollectionRequest, UpdateSourceCollectionRequest, VideosRequest};
use crate::api::response::{
    PageInfo, ResetVideoResponse, SourceCollectionsResponse, VideoInfo, VideoResponse, VideoSource, VideoSourcesResponse, VideosResponse
};
use crate::api::wrapper::{ApiError, ApiResponse};
use crate::utils::status::{PageStatus, VideoStatus};

use super::request::SourceCollectionsRequest;
use super::response::SourceCollectionResp;
...
#[utoipa::path(
    ...
    responses(
        (status = 200, body = ApiResponse<SourceCollectionsResponse>),
    )
)]
pub async fn get_source_collections(
    Extension(db): Extension<Arc<DatabaseConnection>>,
    Query(params): Query<SourceCollectionsRequest>,
) -> Result<ApiResponse<SourceCollectionsResponse>, ApiError> {
    ...
    Ok(ApiResponse::ok(SourceCollectionsResponse {
